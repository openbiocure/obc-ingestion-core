...
from ..config.dataclass_config import AppConfig, ConfigError
...
class DbContext(IDbContext):
    def __init__(self, connection_string: Optional[str] = None):
        # Try to get connection string from AppConfig first if available
        if connection_string is None:
            try:
                ...
                # Fall back to YamlConfig if AppConfig fails
